...
// معلومات الكلاسات مأخوذة من الإنفوجرافيك الخاص بكل كلاس.
const classInfo = {
  "علوي": {
    icon: "🏋🏻‍♀️",
    title: "كلاس علوي",
  ...
  "HIIT": {
    icon: "🏃🏻‍♀️",
    title: "كلاس HIIT",
    focus: "نركز اليوم على تمارين الكارديو عالية الشدة لحرق الدهون وزيادة اللياقة والقدرة على التحمل.",
    targets: [
    ...
    tip: "تمارين HIIT ترفع معدل حرق الدهون حتى بعد انتهاء التمرين، مما يعني نتائج أسرع وجسم أقوى وأكثر رشاقة."
  },
  "ظهر وأكتاف جانبية": {
    icon: "💪🏻",
